...
4. 在浏览器运行，JavaScript 实际上是 ECMAScript 本身，结合浏览器提供的APIs实现功能
   ...
   ![JavaScript在浏览器上运行示意图](https://github.com/FishLyn/task-01-01/blob/master/notes/images/pic_01.png)

   在node环境下，JavaScript 实际上是 ECMAScript 本身，结合node环境提供的APIs实现功能

   ![JavaScript在node环境下的运行示意图](https://github.com/FishLyn/task-01-01/blob/master/notes/images/pic_02.png)
...
1. Proxy 能监视到更多的对象操作，defineProperty只能监视对象的读写
   ...
   ![Proxy可以监视到的对象操作](https://github.com/FishLyn/task-01-01/blob/master/notes/images/pic_03.png)
...
![异步调用示意图](https://github.com/FishLyn/task-01-01/blob/master/notes/images/pic_04.png)
...
![常见的编程语言](https://github.com/FishLyn/task-01-01/blob/master/notes/images/pic_05.png)
...
![TypeScript示意图](https://github.com/FishLyn/task-01-01/blob/master/notes/images/pic_06.png)
